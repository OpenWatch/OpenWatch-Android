...
public class HttpClient {
	...
	public static HttpsURLConnection setupHttpsUrlConnection(Context c, String url_string){
		URL url;
		try {
			url = new URL(url_string);
			HttpsURLConnection urlConnection = (HttpsURLConnection) url.openConnection();
			urlConnection.setSSLSocketFactory(createUrlConnectionSSLFactory(c));
	...
	private static javax.net.ssl.SSLSocketFactory createUrlConnectionSSLFactory(Context c) throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException{
		KeyStore keyStore = loadOWKeyStore(c);
