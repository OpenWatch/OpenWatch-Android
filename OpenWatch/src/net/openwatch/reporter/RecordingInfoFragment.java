...
public class RecordingInfoFragment extends SherlockFragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (model_id == 0) {
			...
			media_obj = OWMediaObject.objects(
					getActivity().getApplicationContext(), OWMediaObject.class)
