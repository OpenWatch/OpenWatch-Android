...
*/
public class OWRemoteImageLoader extends RemoteImageLoader{

   private Context app_context;

   public OWRemoteImageLoader(Context context) {
       super(context);
       this.app_context = context.getApplicationContext();
       Log.i("REMOTEIMAGEVIEW", "MADE IT");
   }
    ...
    */
   public OWRemoteImageLoader(Context context, boolean createCache) {
	   super(context, createCache);
       this.app_context = context.getApplicationContext();
       Log.i("REMOTEIMAGEVIEW", "MADE IT");
   }
   ...
   public void loadImage(Drawable dummyDrawable, RemoteImageLoaderHandler handler) {
       ...
       if (imageCache != null && imageCache.containsKeyInMemory(imageUrl)) {
           ...
           executor.execute(new OWRemoteImageLoaderJob(app_context, imageUrl, imageLoaderHandler, imageCache,
